...
- Compatibility for Floating Point inputs as well as integer inputs.
- The ability to customize the UI aesthetics by changing the background, calculator, button, and output colors.

## Usage Notes
- To use decimals ensure there is always a digit before the decimal point. (Ex: Rather than .4, the proper input is 0.4)
- When negating a number, it must be negated after all the digits have been entered.
